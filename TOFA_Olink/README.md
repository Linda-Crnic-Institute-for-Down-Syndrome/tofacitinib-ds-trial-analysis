...
This workflow analyzes differential abundance of plasma proteins, measured by the Olink assay, 1) at baseline and 16 weeks of Tofacitinib (TOFA) treatment from participants in the clinical trial and 2) between individuals with (T21) and without (D21) Down syndrome in the Human Trisome Project and compares these results.
...
```         
TOFA_Olink/ 
  ├── TOFA_Olink.R                # Main analysis script 
...
* Olink data: [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.19962923.svg)](https://doi.org/10.5281/zenodo.19962923).  
...
* Olink data: [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20046326.svg)](https://doi.org/10.5281/zenodo.20046326).  
