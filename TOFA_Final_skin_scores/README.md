## Tofacitinib for Immune Skin Conditions in Down Syndrome: Analysis of Dermatological (skin) scores
...
This workflow analyzes dermatological (skin) scores for participants in the clinical trial.  
...
## Repository contents  
```         
TOFA_Final_skin_scores/ 
  ├── TOFA_Final_skin_scores.R     # Main analysis script 
