...
```         
TOFA_RNAseq_DESeq2/ 
  ├── TOFA_DESeq2.R               # Main analysis script 
...
* PAXgene whole blood RNAseq data (Counts and RPKMs): [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.19954573.svg)](https://doi.org/10.5281/zenodo.19954573) and GEO: [GSE33018](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE330188).  
...
* PAXgene whole blood RNAseq data (Counts and RPKMs): [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20044079.svg)](https://doi.org/10.5281/zenodo.20044079) and GEO: [GSE190125](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE190125).  
