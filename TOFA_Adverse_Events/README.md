...
This workflow analyzes Adverse Event data based on physician assessment of grade, severity, and relatedness to tofacitinib.  
...
```         
TOFA_Adverse_Events/ 
  ├── TOFA_Adverse_Events.R     # Main analysis script 
