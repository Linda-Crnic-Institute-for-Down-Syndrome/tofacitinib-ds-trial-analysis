...
This workflow analyzes absolute concentrations (µM) of select metabolites (kynurenine, quinolinic acid, tryptophan), measured in plasma from participants in the clinical trial and in the Human Trisome Project using ultra high performance liiquid chromatography mass spectrometry (UHPLC-MS).  
...
```         
TOFA_Metab_AQ/ 
  ├── TOFA_Final_Metab_AQ.R     # Main analysis script 
